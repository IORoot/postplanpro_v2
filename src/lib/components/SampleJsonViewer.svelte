		...
		<div class="pl-4">
			{#each data as value, i}
				<div class="flex flex-wrap items-baseline gap-1">
					<button
						type="button"
						class="rounded bg-white/15 px-1.5 py-0.5 font-mono text-xs text-white cursor-pointer hover:bg-white/25 focus:outline-none focus:ring-1 focus:ring-white/50"
