...
<PageSectionHeading
	title="Webhooks"
	description="Inbound import webhook: send JSON to create posts from Make.com, n8n, or your own scripts. Uses the same webhook token as post notifications (Inputs → Callbacks)."
/>
