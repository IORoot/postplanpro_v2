<script lang="ts">
	...
	const showMapStep = $derived(discovered && sample != null);
...
<section id="sq-import-step-1" class="scroll-mt-8 mt-8">
	...
	<p class="mt-1 text-sm text-[var(--text-muted)]">
		Enter the full URL of your Squarespace <strong>blog</strong> or collection page. The app fetches JSON (<code class="rounded bg-[var(--surface)] px-1 py-0.5 text-xs">?format=json-pretty</code>) and uses the first entry for mapping.
	</p>
	<form
		method="POST"
...
{#if showMapStep}
	...
	>
		...
		<section id="sq-import-step-2" class="scroll-mt-8">
			<div class="flex flex-wrap items-center gap-2 text-sm text-[var(--text-muted)]">
			...
			<p class="mt-1 text-sm text-[var(--text-muted)]">Set how each Squarespace item field maps into your posts.</p>
			<div class="bulk-create-step3-grid mt-6 gap-8">
				<div class="min-w-0 space-y-6">
					<div class="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-5">
						...
						<div class="mt-4">
							...
							<input id="sq_title_path" type="text" name="title_path" bind:value={titlePath} list="sq_title_paths" class="mt-1 w-full min-h-[44px] rounded border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-[var(--text)]" />
						...
						<div class="mt-6">
							...
							<input id="sq_content_path" type="text" name="content_path" bind:value={contentPath} list="sq_content_paths" class="mt-1 w-full min-h-[44px] rounded border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-[var(--text)]" />
						...
						<div class="mt-6">
							...
							<input id="sq_image_url_path" type="text" name="image_url_path" bind:value={imageUrlPath} list="sq_image_url_paths" class="mt-1 w-full min-h-[44px] rounded border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-[var(--text)]" />
				...
				<aside class="bulk-create-step3-sidebar space-y-6 rounded-xl border border-[var(--border)] bg-[var(--surface)] p-5">
					...
					{#if samplePreviewData != null}
						<div class="space-y-2">
							<p class="font-medium text-[var(--text)]">Example item</p>
							<div class="relative">
			...
			<div class="mt-6 flex flex-wrap gap-2">
				<button
					...
					onclick={() => {
						...
						document.getElementById('sq-import-step-3')?.scrollIntoView({ behavior: 'smooth', block: 'start' });
					}}
				>
		...
		<section id="sq-import-step-3" class="scroll-mt-8" hidden={importFlowUnlocked < 3}>
			<div class="flex flex-wrap items-center gap-2 text-sm text-[var(--text-muted)]">
			...
			<div class="mt-6 flex flex-wrap gap-2">
				<button type="button" class="rounded-lg border border-[var(--border)] bg-[var(--surface)] px-4 py-2.5 text-sm font-medium text-[var(--text)] hover:bg-[var(--surface-hover)] min-h-[44px]" onclick={() => document.getElementById('sq-import-step-2')?.scrollIntoView({ behavior: 'smooth', block: 'start' })}>Back to map fields</button>
				<button
					type="button"
					class="rounded-lg btn-primary px-4 py-2.5 text-sm font-medium text-white min-h-[44px]"
					onclick={() => {
						importFlowUnlocked = 4;
						document.getElementById('sq-import-step-4')?.scrollIntoView({ behavior: 'smooth', block: 'start' });
					}}
				>
		...
		<section id="sq-import-step-4" class="scroll-mt-8" hidden={importFlowUnlocked < 4}>
			<div class="flex flex-wrap items-center gap-2 text-sm text-[var(--text-muted)]">
			...
			<p class="mt-1 text-sm text-[var(--text-muted)]">Choose which items to import. Max 500 per import.</p>
			<div class="importer-panel-filters mt-4">
			...
			<div class="mt-6 flex flex-wrap gap-2">
				<button type="button" class="rounded-lg border border-[var(--border)] bg-[var(--surface)] px-4 py-2.5 text-sm font-medium text-[var(--text)] hover:bg-[var(--surface-hover)] min-h-[44px]" onclick={() => document.getElementById('sq-import-step-3')?.scrollIntoView({ behavior: 'smooth', block: 'start' })}>Back to import filters</button>
				<button
					type="button"
					class="rounded-lg btn-primary px-4 py-2.5 text-sm font-medium text-white min-h-[44px]"
					onclick={() => {
						importFlowUnlocked = 5;
						document.getElementById('sq-import-step-5')?.scrollIntoView({ behavior: 'smooth', block: 'start' });
					}}
				>
		...
		<section id="sq-import-step-5" class="scroll-mt-8" hidden={importFlowUnlocked < 5}>
			<div class="flex flex-wrap items-center gap-2 text-sm text-[var(--text-muted)]">
			...
			<div class="mt-6 space-y-6">
				...
				<div class="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-5">
					...
					<label for="sq_schedule_id" class="mt-3 block text-sm font-medium text-[var(--text)]">Schedule</label>
				...
				<div class="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-5">
					...
					<label for="sq_import_status" class="mt-3 block text-sm font-medium text-[var(--text)]">Status</label>
				...
				<button type="button" class="rounded-lg border border-[var(--border)] bg-[var(--surface)] px-4 py-2.5 text-sm font-medium text-[var(--text)] hover:bg-[var(--surface-hover)] min-h-[44px]" onclick={() => document.getElementById('sq-import-step-4')?.scrollIntoView({ behavior: 'smooth', block: 'start' })}>Back to import range</button>
